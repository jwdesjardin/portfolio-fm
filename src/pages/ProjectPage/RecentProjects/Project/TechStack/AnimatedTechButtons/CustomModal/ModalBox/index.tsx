...
export const ModalBox: React.FC<ModalBoxProps> = ({ setOpenModal, animateVar }) => {
  ...
  const ModalVariants = {
    initial: { scale: 0.1, opacity: 0, x: 0 },
    animateLeft: { scale: 1, opacity: 1, x: -50 },
    animateRight: { scale: 1, opacity: 1, x: 50 },
